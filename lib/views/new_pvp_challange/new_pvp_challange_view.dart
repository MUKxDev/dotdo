...
class NewPvpChallangeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<NewPvpChallangeViewModel>.reactive(
      onModelReady: (NewPvpChallangeViewModel viewModel) =>
          viewModel.handelStartup(challengeId, pvpId),
      builder:
          (BuildContext context, NewPvpChallangeViewModel viewModel, Widget _) {
